...
describe('ClaudeChatRuntime', () => {
  let mockPlugin: Partial<ClaudianPlusPlugin>;
  ...
  beforeEach(() => {
    ...
    mockPlugin = {
      ...
      settings: {
        ...
        thinkingBudget: 0,
        mediaFolder: 'claudian-plus-media',
        systemPrompt: '',
  ...
  describe('applyDynamicUpdates', () => {
    ...
    it('should update MCP servers when changed', async () => {
      ...
      (service as any).obsidianMcpServer = {
        type: 'sdk',
        name: 'obsidian',
        instance: {},
      };
      ...
      expect(mockPersistentQuery.setMcpServers).toHaveBeenCalledWith({
        'test-server': { command: 'test', args: [] },
        obsidian: expect.objectContaining({ type: 'sdk', name: 'obsidian' }),
      });
    });
